...
import com.estatementsgenerate.repositoies.TxnRecordRepository;
...
public class JobConfig {
	...
	private final TxnRecordRepository recordRepository;
	...
	public Step step() {
		return new StepBuilder("step", jobRepository)
				.<TransactionRecord, TransactionRecord>chunk(10, manager)
	...
	@Bean
	public RepositoryItemWriter<? super TransactionRecord> writer() {
	...
	@Bean
	public MultiResourceItemReader<TransactionRecord> multipleFileItemReader() {
	...
	private Resource[] resouresFiles() {
		return new Resource[] {
				new ClassPathResource("STMT3_SAMPLE.txt"), 
		};
	}
	
	@Bean
	public FlatFileItemReader<TransactionRecord> flatFileItemReader() {
	...
	public FixedLengthTokenizer fixedLengthTokenizer() {
	    ...
	    tokenizer.setColumns(new Range[] {
	        new Range(1, 5), new Range(6, 9), new Range(10, 12), new Range(13, 31), 
	    ...
	    tokenizer.setNames(new String[] {
	        "statementNo", "sequenceNo", "lineSeqNo", "textLetterKey", "stmtRecordType", 
